<template>
    <div class="post">
        ...
        <div class="post__project-info">
            ...
            <div class="post__project-info_article">
                <div class="post__project-info_article-foto ml" v-bind:style="{ backgroundImage: 'url(.' + project[language.numOfLang].image[2] + ')'}"></div>
                <div class="post__project-info_article-text">
        ...
        <div class="post__gallery owl-carousel owl-theme">
            ...
            <div class="post__gallery_item" v-for="(image, index) in project[language.numOfLang].image" :key="index" v-bind:style="{ backgroundImage: 'url(.' + image + ')'}" v-bind:data-index="index">
...
import language from "../../settings/language";
    ...
    export default {
        ...
        mounted: function() {
            setTimeout( () => {
                this.allSlides = Array.from(document.getElementsByClassName("post__gallery_item"));
