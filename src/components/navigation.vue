  ...
  <nav class="block-nav__full-head">
    ...
    <div class="block-nav__full-head_navigation" v-if="smallScreen === false">
      <router-link
        ...
        to="/about"
      >
        <span>{{titles[language.numOfLang].about}}</span>
      </router-link>
      <router-link
        class="block-nav__full-head_navigation-link"
        to="/projects"
        v-bind:class="{ active: isActive }"
      >
        <span v-on:mouseover="mouseOver()">{{titles[language.numOfLang].projects}}</span>
      </router-link>
      <router-link
        class="block-nav__full-head_navigation-link"
        to="/team"
        v-bind:class="{ active: isActive }"
      >
        <span>{{titles[language.numOfLang].team}}</span>
      </router-link>
      <router-link
        class="block-nav__full-head_navigation-link"
        to="/contacts"
        v-bind:class="{ active: isActive }"
      >
        <span>{{titles[language.numOfLang].contacts}}</span>
      </router-link>
    </div>

    <div id="smallMenu" class="block-nav__small-head_navigation" v-if="smallScreen">
      ...
      <div class="block__menu menu_close">
        <div>
          <router-link
            class="block-nav__small-head_navigation-link"
            v-bind:class="{ active: isActive }"
            to="/about"
          >
            <span @click="openMenu()">{{titles[language.numOfLang].about}}</span>
          </router-link>
          ...
          <router-link
            ...
            v-bind:class="{ active: isActive }"
          >
            <span @click="openMenu()">{{titles[language.numOfLang].projects}}</span>
          </router-link>
          ...
          <router-link
            ...
            v-bind:class="{ active: isActive }"
          >
            <span @click="openMenu()">{{titles[language.numOfLang].team}}</span>
          </router-link>
          ...
          <router-link
            ...
            v-bind:class="{ active: isActive }"
          >
            <span @click="openMenu()">{{titles[language.numOfLang].contacts}}</span>
          </router-link>
        </div>
      </div>
    </div>
    ...
    <div class="block-nav__full-head_share" id="iconsShare">
      <a
        href="https://share.yandex.net/go.xml?service=facebook&url=http%3A%2F%2Fwww.kutsevych.com%2F&title=%D0%90%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%BD%D0%B0%D1%8F%20%D1%81%D1%82%D1%83%D0%B4%D0%B8%D1%8F%20%D0%9A%D1%83%D1%86%D0%B5%D0%B2%D0%B8%D1%87%20%2B%20%D0%BF%D0%B0%D1%80%D1%82%D0%BD%D0%B5%D1%80%D1%8B%20-%20%D0%93%D0%9B%D0%90%D0%92%D0%9D%D0%90%D0%AF"
        class="facebook"
        target="_blank"
        title="Facebook"
      >
      ...
      <a
        href="https://share.yandex.net/go.xml?service=twitter&url=http%3A%2F%2Fwww.kutsevych.com%2F&title=%D0%90%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%BD%D0%B0%D1%8F%20%D1%81%D1%82%D1%83%D0%B4%D0%B8%D1%8F%20%D0%9A%D1%83%D1%86%D0%B5%D0%B2%D0%B8%D1%87%20%2B%20%D0%BF%D0%B0%D1%80%D1%82%D0%BD%D0%B5%D1%80%D1%8B%20-%20%D0%93%D0%9B%D0%90%D0%92%D0%9D%D0%90%D0%AF"
        class="twitter"
        target="_blank"
        title="Twitter"
      >
      ...
      >{{ language.english ? "EN" : "РУ"}}</div>
    </div>
    <div
      class="block-nav__full-head_categories"
      v-bind:class="{showCategories: !showCat}"
      id="categories"
  ...
  methods: {
    ...
    changeLanguage() {
      ...
      this.language.english
        ? (this.language.numOfLang = 1)
        : (this.language.numOfLang = 0);
    },
    openMenu() {
      ...
      if (
        ...
        menu.classList.contains("menu_opening")
      ) {
